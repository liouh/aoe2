export const getBuildingIcon = (name: string): string | null => {
  ...
  else if (name.includes("Monastery") || name.includes("Church")) icon = "🙏";
  ...
  else if (name.includes("University")) icon = "🎓";
  else if (name.includes("Wall")) icon = "■";
  else if (name.includes("Wonder") || name.includes("Feitoria") || name.includes("Caravanserai")) icon = "🏛️";
